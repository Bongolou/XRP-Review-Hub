...
const LABELS = {
  en: {
    ...
    headerName: "XRPL Wallet Shortlist",
    coverTitle: ["Wallet", "Shortlist"],
    inside: "What's inside",
    page: "Page",
  },
  es: {
    eyebrow: "ALL THINGS XRPL",
    headerName: "Lista breve de carteras XRPL",
    coverTitle: ["Lista breve", "de carteras"],
    inside: "Qué hay dentro",
    page: "Página",
  },
  zh: {
    eyebrow: "ALL THINGS XRPL",
    headerName: "XRPL 钱包精选清单",
    coverTitle: ["钱包", "精选清单"],
    inside: "内容简介",
    page: "第",
  },
  ja: {
    eyebrow: "ALL THINGS XRPL",
    headerName: "XRPL ウォレット ショートリスト",
    coverTitle: ["ウォレット", "ショートリスト"],
    inside: "収録内容",
    page: "ページ",
  },
  ko: {
    eyebrow: "ALL THINGS XRPL",
    headerName: "XRPL 지갑 숏리스트",
    coverTitle: ["지갑", "숏리스트"],
    inside: "이 키트의 내용",
    page: "페이지",
  },
  pt: {
    eyebrow: "ALL THINGS XRPL",
    headerName: "Lista resumida de carteiras XRPL",
    coverTitle: ["Lista resumida", "de carteiras"],
  ...
  fr: {
    eyebrow: "ALL THINGS XRPL",
    headerName: "Sélection de wallets XRPL",
    coverTitle: ["Sélection", "de wallets"],
...
function generateForLanguage(lang) {
  ...
  const sourceFile =
    lang === "en"
      ? path.join(sourceDir, "xrpl-wallet-shortlist.md")
      : path.join(sourceDir, `xrpl-wallet-shortlist.${lang}.md`);
  const outPath =
    lang === "en"
      ? path.join(outDir, "xrpl-wallet-shortlist.pdf")
      : path.join(outDir, `xrpl-wallet-shortlist.${lang}.pdf`);
  ...
  const doc = new PDFDocument({
    ...
    info: {
      ...
      Subject: "One-page XRP wallet shortlist",
      Keywords: "XRPL, XRP, wallet, shortlist, Xaman, Ledger, Trezor, Tangem, Crossmark",
    },
  });
      ...
      case "table":
        {
          ...
          let widths;
          if (n === 4) {
            widths = [120, 110, 70, contentWidth - 120 - 110 - 70];
          } else if (n === 3) {
