  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 max-w-4xl py-20 md:py-24">
          ...
          <div className="bg-card/30 backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a 
                  href="https://wallet.uphold.com/signup?referral=allthingsxrpl" 
                  target="_blank" 
        ...
        <div className="mt-16 bg-gradient-to-r from-primary/20 to-secondary/20 border border-white/10 rounded-2xl p-6 md:p-8 text-center">
