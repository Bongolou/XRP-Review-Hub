        ...
        <div className="bg-card/30 backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8 mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8">
            <div className="flex items-start gap-5">
              ...
              <div>
                <div className="text-sm text-primary font-display mb-3">{t(exchange.typeKey)}</div>
                <h1 className="text-3xl md:text-4xl font-black font-display mb-3">{exchange.name}</h1>
          ...
          <a 
            href={localizeAffiliateUrl(exchange.affiliateLink, language)}
            target="_blank"
